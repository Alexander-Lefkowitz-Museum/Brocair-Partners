var brocair = {
	...
	gcUpdate: function (country) {
		...
		//big switch statement for country rotations, because they all have different numbers of images
		if(country == "denmark" || country == "mexico" || country == "uk"){
			$(".story header .rotatingHeader .slides_container").html('<div><img id="slideImg1" src="assets/images/global_'+country+'_bb1.jpg"></div>');
		}else if(country == "canada" || country == "germany" || country == "us"){
			$(".story header .rotatingHeader .slides_container").html('<div><img id="slideImg1" src="assets/images/global_'+country+'_bb1.jpg"></div><div><img id="slideImg2" src="assets/images/global_'+country+'_bb2.jpg"></div><div><img id="slideImg3" src="assets/images/global_'+country+'_bb3.jpg"></div>');
		} else {
			$(".story header .rotatingHeader .slides_container").html('<div><img id="slideImg1" src="assets/images/global_'+country+'_bb1.jpg"></div><div><img id="slideImg2" src="assets/images/global_'+country+'_bb2.jpg"></div>');
		}
	...
	toMember: function (member) {
		...
		if(member == 'fagan'){
			$(".story header .billboard").css("background","url('assets/images/stlouis_bb.jpg')");
		}else{
	...
	toNews: function () {
		...
		$("#news1").addClass("active").show();
		$("header .dropDown li").removeClass("active");
	    $("aside li").removeClass("active");
	    $("aside a.news").parent().addClass("active");
	    $(".news",$about).fadeIn(150);
	    $(".teamHeader",$about).css("display","none");
	    $(".locationsHeader",$about).css("display","none");
	    $(".location",$about).css("display","none");
	...
	newsChange: function (){
		newsDrop = $("#newsDropdown").val();
		$("article.active").hide();
		$("#"+newsDrop).show().addClass("active");
	},
